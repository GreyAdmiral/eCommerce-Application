                     ...
                     {promoCodeName && cart.discountOnTotalPrice?.discountedAmount && (
                        <>
                           ...
                           <div className={classnames(styles.totalPriceWrapper, styles.discount)}>
                              Discount:{' '}
                              <span>
                                 {convertCentsToDollarsString(cart.discountOnTotalPrice.discountedAmount.centAmount)}
                              </span>
                           </div>
                        </>
                     )}
                     <div className={styles.totalPriceWrapper}>
                        ...
                        <span
                           className={classnames({
                              [styles.discountedFinalPrice]: cart.discountOnTotalPrice?.discountedAmount,
                           })}
                        >
