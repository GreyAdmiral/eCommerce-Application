         ...
         <div className={styles.section}>
            ...
            <div className={styles.content} data-expanded={expandedSection === 'returnPolicy'}>
               <p className={styles.text}>
                  We hope you love your purchase, but if you are not completely satisfied, you can return the product to
                  us within 30 days for a full refund. The item must be in its original condition and packaging.
               </p>
            </div>
         </div>
         <div className={styles.section}>
            ...
            <div className={styles.content} data-expanded={expandedSection === 'shippingInfo'}>
               <p className={styles.text}>
                  We offer free standard shipping on all orders. Expedited shipping is available at an additional cost.
                  Orders are processed within 1-2 business days and delivery typically takes 3-5 business days.
               </p>
            </div>
         </div>
      </div>
